...
| Sol B2 X/Twitter strict card evidence | Codex primary | `content_platform/hot_work_intelligence.py`, `tests/test_hot_work_intelligence.py` and four coordination documents | local_complete | commit with current milestone; repeat isolated live X collection and strict pack report |
