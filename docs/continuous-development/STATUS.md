...
- Latest complete regression on this branch: 1837 passed + 37 subtests; zero failures; JUnit saved at `artifacts/test-reports/sol-b2-youtube-month-cards-20260911.xml`.

## Active work

| Work item | Owner | Files reserved | State | Next verification |
|---|---|---|---|---|
| Sol B2 YouTube this-month visible-card contract | Codex primary | YouTube URL/card parser, tests and four coordination documents | local_complete | commit, staging sync and default-query Linux strict acceptance |
