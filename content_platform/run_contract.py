...
STAGE_FIELDS = {
    ...
    "generate": {"content_blueprint", "topic_decision", "content_profile", "capability_plan", "tool_selection", "compiled_skill_rules", "associated_hotspot", "claim_ledger", "tool_selection_plan", "strategy", "content_quality_reference_pack", "runtime_capabilities", "distilled_per_account", "hot_work_parameter_pack", "same_lane_intelligence"},
