...
STAGE_FIELDS = {
    ...
    "generate": {"content_blueprint", "claim_ledger", "tool_selection_plan", "strategy", "content_quality_reference_pack", "runtime_capabilities", "same_lane_intelligence", "hot_work_parameter_pack", "capability_plan", "compiled_skill_rules", "content_profile", "tool_selection"},
