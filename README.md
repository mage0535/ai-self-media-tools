...
2. 使用外部工具登录账号，账号文件保存在该工具自己的 `cookies/` 目录，例如 `douyin_main.json`、`bilibili_main.json`。
...
- **[Knowledge-and-Memory-Management](https://github.com/mage0535/Knowledge-and-Memory-Management)** — AI 知识采集与记忆体管理插件。40+ 采集工具、SenseNova 文档引擎、12+ 云盘同步、三层知识召回。
