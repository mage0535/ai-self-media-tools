...
def render_config(home: Path, *, overwrite: bool = False) -> Path:
    template = {
        ...
        "publishers": {
            ...
            "platforms": {
                "kuaishou": {"type": "social-auto-upload", "account_name": "<account-alias>"},
                ...
                "bilibili": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "douyin": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "douyin_ai": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "douyin_pet": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "shipinhao": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "xiaohongshu": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "rednote": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "reddit": {
                    "type": "reddit-draft",
                    "outbox": str(home / "data" / "outbox"),
                    "default_subreddit": "manual-selection",
                },
                "youtube": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
                "tiktok": {"type": "manual-handoff", "outbox": str(home / "data" / "outbox")},
