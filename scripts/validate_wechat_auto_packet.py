#!/usr/bin/env python3
"""Validate a WeChat Official Account auto-workflow packet."""
...
from content_platform.media_quality import validate_wechat_auto_packet
...
def main() -> int:
    ...
    parser.add_argument("packet", help="JSON packet produced before WeChat draft upload")
