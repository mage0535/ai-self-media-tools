    ...
    return {
        "platform_source_matrix": {
            ...
            "attempted_sources": [
                ...
                {"source": "zhihu", "status": "success", "sample_count": 2},
                {"source": "juejin", "status": "success", "sample_count": 2},
                {"source": "search_trend", "status": "failed", "reason": "rate limited"},
            ],
            "successful_source_count": 6,
