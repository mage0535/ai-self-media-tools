...
class VideoToolchainRunnerTests(unittest.TestCase):
    ...
    def test_runner_dry_run_materializes_plan_cards_and_output(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(manifest["form_selection"]["selected_form"])
            self.assertTrue(manifest["form_selection"]["rejected_forms"])
            self.assertTrue(manifest["form_selection"]["form_selection_reason"])
