"""Tests for the zhihu-cli adapter (hot/search + pin/ask publishing)."""
import json
...
HOT_PAYLOAD = [
    ...
    {
        "question": {"title": "如何评价人民网 Token 还是词元？", "url": "https://www.zhihu.com/question/2", "id": "2"},
...
class TestZhihuCliAdapter:
    ...
    def test_timeout_raises_zhihu_cli_error(self):
        import subprocess
        adapter = ZhihuCliAdapter(binary="/bin/echo", timeout=1)
