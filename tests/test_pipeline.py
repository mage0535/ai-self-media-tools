...
class PipelineTests(unittest.TestCase):
    ...
    def test_pipeline_persists_topic_decision_and_sends_it_to_provider(self):
        ...
        candidate = {
            ...
            "content_id": "wechat-article-example",
            "author_id_hash": "a" * 64,
            "title": "AI工作流三步实测",
            ...
            "fetched_at": "2026-09-10T08:00:00+00:00",
            "query": "AI 工作流",
            "collector": "wechat_article_collector",
            "views": 1200,
            "metrics": {"views": 1200},
            "metric_observed_at": "2026-09-10T08:00:00+00:00",
    ...
    def test_automated_video_completes_known_terminal_cta_before_hygiene_gate(self):
        body = (
            ...
            "Compare the generated result with the original requirement, platform rules, and audience need before release.\n\n"
            "Revise only the part that failed its recorded quality gate, then repeat the same deterministic check.\n\n"
            "Save this"
        )
